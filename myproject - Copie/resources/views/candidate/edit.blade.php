...
<div class="container mt-2 pt-1">
  <div class="container text_top">
    <div><h1>Edit Your Job Application</h1></div>
    Thank you for taking the time to apply for our job opening! We appreciate your interest in our company, and we're glad to see that you're still interested in this position. Please review and edit your application information below, and feel free to upload any additional materials or documents that you'd like to include. Once you're done, simply click the "Update" button to save your changes. If you have any questions or concerns, please don't hesitate to contact us. Thank you again for your time and effort in applying, and we wish you the best of luck in your job search!
    </div>


<div class="container main_c">
<form action="/my-candidates/{{ $candidate->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
...
<!-- <input type="hidden" name="offre_id" value="{{Auth::user()->id}} "> -->
...
<div class="group">
  ...
  <input autocomplete="off" name="nom" class="input" type="text" value="{{$candidate->nom}}">
</div>
<div class="group">
  <label class="label">First Name</label>
  <input autocomplete="off" name="prenom" class="input" type="text" value="{{$candidate->prenom}}">
...
<div class="group">
  ...
  <input autocomplete="off" name="email" class="input" type="email" value="{{$candidate->email}}">
...
<div class="group">
  ...
  <input autocomplete="off" name="phone" class="input" type="text" value="{{$candidate->phone}}">
...
<div class="group">
  ...
  <input autocomplete="off" name="date_naissance" class="input" type="date" value="{{$candidate->date_naissance}}">
