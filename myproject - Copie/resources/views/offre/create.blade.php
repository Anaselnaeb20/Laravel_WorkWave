...
box-shadow:  31px 31px 45px #F6F1F1,
             -31px -31px 45px #ffffff;
    ...
    .container1 ,.container2 {
        border-radius: 39px;
/* background: linear-gradient(145deg, #cacaca, #f0f0f0); */
box-shadow:  31px 31px 45px #b3b3b3,
             -31px -31px 45px #ffffff;
...
<h1>Here you can create your job offer</h1>
Fill out the required fields below to create a new job offer. Provide clear and concise information about the job title, responsibilities, requirements, and qualifications. You can also add additional information about your company to make your job offer more appealing to candidates. 

Once you've completed the form, click "Add offer" to post your job offer. You can track and manage your job offer using the tools on your dashboard.
...
<div class="container d-flex mb-5" >
    <div class="container1 ">
        <div class="title title19">Add your Offre</div>
        <form action="/offre" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-outline mb-4">
    <input type="text" name="titre" placeholder="Job" class="input" />
</div>
<div class="form-outline mb-4">
    <input type="text" name="ville" placeholder="City" class="input" />
</div>
<div class="form-outline mb-4">
    <input type="text" name="pays" placeholder="Country" class="input" />
</div>
<div class="form-outline mb-4">
    <input type="text" name="societe" placeholder="Company" class="input" />
</div>
<div class="form-outline mb-4">
    <input type="text" name="descreption" placeholder="Brief descreption of the offer" class="input" />
</div>
<div class="form-outline mb-4">
    <textarea class="form-control" rows="4" name="contenue" placeholder="Offer contenent"></textarea>
  ...
  <div class="select">
    <select name="type_contrat">
        ...
        <option value='Freelans'>Freelans</option>
    </select>
    <div class="select_arrow">
    </div>
    </div>
    <div class="form-outline mb-4 " >
    <input type="text" name="salair" placeholder="Salary" class="input" style="width:380px;
    margin-left:12em" />
</div>
</div>
<button type="submit" class="btn_submit" >Add Offre</button>
