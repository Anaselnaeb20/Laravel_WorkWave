...
<div class="container0">
    <div class="container1 ">
        <div class="title"><h1>Edit Your Offre</h1></div>
        <form action="/offre/{{$offre->slug}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="form-outline mb-4">
    <input type="text" name="titre" placeholder="Post"value="{{$offre->titre}}" class="input" />
</div>
<div class="form-outline mb-4">
    <input type="text" name="ville" placeholder="Ville"value="{{$offre->ville}}" class="input" />
</div>
<div class="form-outline mb-4">
    <input type="text" name="pays" placeholder="Pays"value="{{$offre->pays}}" class="input" />
</div>
<div class="form-outline mb-4">
    <input type="text" name="societe" placeholder="Societe"value="{{$offre->societe}}" class="input" />
</div>
<div class="form-outline mb-4">
    <input type="text" name="descreption" placeholder="Petit descreption de l'offre" class="input"value="{{$offre->description}}" />
</div>
<div class="form-outline mb-4">
    <textarea class="form-control" rows="4" name="contenue" placeholder="Contenue de l'offre">{{$offre->contenu}}</textarea>
  ...
  <div class="select">
    ...
    <div class="form-outline mb-4 " >
    <input type="text" name="salair" placeholder="Salair" class="input" style="width:380px;
    margin-left:12em" value="{{$offre->salair}}" />
</div>
</div>
<button type="submit" class="btn_submit" >Submit</button>
    ...
    <div class="title"><h1>Post your job offer now and connect with top talent !</h1></div>
